...
const AsistenciasTable = ({ disableButtons }) => {
    ...
    const fetchAsisNec = async () => {
        ...
        try {
            const response = await fetch('http://localhost:3000/api/asisnec', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const createMiembro = async () => {
        try {
            ...
            const res = await fetch('http://localhost:3000/api/miembros', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const updateMiembro = async (miembro) => {
        ...
        try {
            const response = await fetch(`http://localhost:3000/api/miembros/${miembro.id}`, {
                method: 'PUT',
                headers: { 
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}` 
    ...
    const updateAsisNec = async (asisnec) => {
        ...
        try {
            const response = await fetch(`http://localhost:3000/api/asisnec/${asisnec.id}`, {
                method: 'PUT',
                headers: { 
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const calcularCobros = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/api/miembros/calcular-cobros', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    const pagoCobros = async (miembroId) => {
        try {
            ...
            const response = await fetch(`http://localhost:3000/api/miembros/pago-cobros/${miembroId}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
